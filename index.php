...
<head>
  ...
  <meta name="description" content="Bei LabCode gibt es technische Anwendungen und selbstgebaute Spiele. Zum Beispiel einen Taschenrechner, Zufallsgenerator der Zahlen und M&uuml;nzseiten, Ratespiel." />
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0, user-scalable=no" />
	<meta name="theme-color" content="#2196F3">
	<title>Home - LabCode technische Anwendungen und selbstgebaute Spiele</title>
  ...
  <link rel="shortcut icon" href="_icons/labcode.ico">
	<link rel="icon" sizes="16x16 32x32 64x64" href="_icons/labcode.ico">
	<link rel="icon" type="image/png" sizes="196x196" href="_icons/labcode-192.png">
	<link rel="icon" type="image/png" sizes="160x160" href="_icons/labcode-160.png">
	<link rel="icon" type="image/png" sizes="96x96" href="_icons/labcode-96.png">
	<link rel="icon" type="image/png" sizes="64x64" href="_icons/labcode-64.png">
	<link rel="icon" type="image/png" sizes="32x32" href="_icons/labcode-32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="_icons/labcode-16.png">
	<link rel="apple-touch-icon" href="_icons/labcode-57.png">
	<link rel="apple-touch-icon" sizes="114x114" href="_icons/labcode-114.png">
	<link rel="apple-touch-icon" sizes="72x72" href="_icons/labcode-72.png">
	<link rel="apple-touch-icon" sizes="144x144" href="_icons/labcode-144.png">
	<link rel="apple-touch-icon" sizes="60x60" href="_icons/labcode-60.png">
	<link rel="apple-touch-icon" sizes="120x120" href="_icons/labcode-120.png">
	<link rel="apple-touch-icon" sizes="76x76" href="_icons/labcode-76.png">
</head>
...
<body id="top" class="scrollspy">
	...
	<div class="section no-pad-bot" id="index-banner">
		<div class="container">
            ...
            <span class="cd-words-wrapper waiting">
                <b class="is-visible">developing</b>
                <b>designing</b>
								<b>Innovation</b>
            </span>
        </h1>
	...
	<div id="intro" class="section scrollspy">
		<div class="container">
			<div class="row">
				<div class="col s12">
					<h2 class="center header text_h2"> Bei LabCode gibt es technische<span class="span_h2"> Anwendungen </span>und selbstgebaute<span class="span_h2"> Spiele.</span> </h2>
				</div>
				...
				<div class="col s12 m4 l4">
					<div class="card">
						<div class="card-image waves-effect waves-block waves-light">
							<img alt="Taschenrechner-Bild" class="transform activator" width="80%" src="img/calculator.svg">
						</div>
 ...
 Taschenrechner</a></p>
				...
				<div class="col s12 m4 l4">
					<div class="card">
						<div class="card-image waves-effect waves-block waves-light">
							<img alt="W&uuml;rfel-Bild" class="transform activator" width="80%" src="img/dices.svg">
						</div>
						<div class="card-content">
				...
				<div class="col s12 m4 l4">
					<div class="card">
						<div class="card-image waves-effect waves-block waves-light">
							<img alt="Zufallsgenerator-Bild" class="transform activator" width="80%" src="img/dice.svg">
						</div>
						<div class="card-content">
            ...
            <div class="col s12 m4 l4">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <img class="transform activator" width="80%" src="img/arrow_keys.jpg">
                    </div>
                    <div class="card-content">
                        <span class="card-title activator grey-text text-darken-4">JumpAndRun <i class="mdi-navigation-more-vert right"></i></span>
                        <p><a href="http://jumpandrun.labcode.de">Link zum Jump AndRun</a></p>
                    </div>
                    <div class="card-reveal">
                        <span class="card-title grey-text text-darken-4">JumpAndRun <i class="mdi-navigation-close right"></i></span>
                        <p>Das LabCode JumpAndRun ist ein JumpAndRun Game mit drei Leveln</p>
                    </div>
                </div>
            </div>
<!--            <div class="col s12 m4 l4">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col s12 m3">
					<div class="card card-avatar">
						<div class="waves-effect waves-block waves-light">
							<img alt="Avatar1" class="transform activator" src="img/avatar1.png">
						</div>
						<div class="card-content">
				...
				<div class="col s12 m3">
					<div class="card card-avatar">
						<div class="waves-effect waves-block waves-light">
							<img alt="Avatar2" class="transform activator" src="img/avatar2.png">
						</div>
						<div class="card-content">
				...
				<div class="col s12 m3">
					<div class="card card-avatar">
						<div class="waves-effect waves-block waves-light">
							<img alt="Avatar3" class=" transform activator" src="img/avatar3.png">
						</div>
						<div class="card-content">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col l3 s12">
					<h5 class="white-text">labcode.de</h5>
					<ul>
						<li><a class="white-text" href="//labcode.de/">Home</a></li>
					</ul>
				</div>
				<div class="col l3 s12">
					...
					<ul>
						<li>
							<a class="white-text" href="https://github.com/labcode-de">
