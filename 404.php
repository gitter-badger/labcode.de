...
<div id="intro" class="section scrollspy">
    <div class="container">
        <div class="row">
            <div  class="col s12">
                <h2 class="center header text_h2">Der Autor der Site wusste nicht, dass <span class="span_h2">coole</span> URIs (<?php echo $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']?>) sich nicht ändern und hat die Ressource gelöscht oder verschoben. Dadurch stimmen Lesezeichen, Links auf die Site sowie Einträge in Suchmaschinen <span class="span_h2">nicht</span> mehr.</h2>
            </div>
